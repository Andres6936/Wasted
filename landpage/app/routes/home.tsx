export default function Home() {
    return (
        <>
            ...
            <section className={"flex flex-col container mx-auto"}>
                <article className={"flex flex-col md:flex-row justify-between gap-24 items-start px-20 py-12"}>
                ...
                <article className={"flex flex-col md:flex-row flex-nowrap overflow-hidden gap-4 px-16 pb-12"}>
